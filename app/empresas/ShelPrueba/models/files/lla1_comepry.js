...
'num_pry': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: 'NUMERO DE PROYECTO' },
'per_pry': {type: DataTypes.CHAR(1),allowNull: false,defaultValue: ' ',comment: 'PERIODICIDAD' },
'cop_nom': {type: DataTypes.CHAR(1),allowNull: false,defaultValue: ' ',comment: 'C=CLIENTE P=PROVEEDOR N=NO AFECTA' },
'cod_nom': {type: DataTypes.CHAR(12),allowNull: false,defaultValue: ' ',comment: 'CODIGO DEL CLIENTE/PROVEEDOR' },
'con_con': {type: DataTypes.INT,allowNull: false,defaultValue: '0',comment: 'NUMERO DE CONSIGNATARIO' },
...
'fco_pry': {type: DataTypes.CHAR(1),allowNull: false,defaultValue: ' ',comment: 'FORMA DE COTIZACION 1=POR DESCRIPCION 2=POR INSUMO' },
'est_pry': {type: DataTypes.CHAR(2),allowNull: false,defaultValue: ' ',comment: 'ESTATUS I=INICIO F=FINCADO M=CONFORMADO C=COSTEADO A=AUTORIZADO Z=COTIZADO B=BLOQUEADO P=ACEPTADO' },
'mes_pry': {type: DataTypes.CHAR(128),allowNull: false,defaultValue: ' ',comment: 'MENSAJE  DEL ESTATUS' },
...
'equ_equ': {type: DataTypes.CHAR(128),allowNull: false,defaultValue: ' ',comment: 'EQUIPO DE TRABAJO' },
...
'log_usu': {type: DataTypes.CHAR(32),allowNull: false,defaultValue: ' ',comment: 'LOGIN USUARIO CAPTURA' },
