...
'num_fim': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE IMPRESION"  },
...
'cim_fim': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CONTINUA LA IMPRESION  1=SI ;0=NO"  },
