...
'num_len': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE MENSAJE"  },
...
'rmo_len': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "REMOVEOBJECT"  },
