...
'top_top': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "PERTENECE AL TOP DE VENTAS"  },
'nue_top': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "PRODUCTOS NUEVOS"  },
'des_top': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "PRODUCTOS DESTACADOS"  },
