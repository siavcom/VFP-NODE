...
'cao_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CADENA ORIGINAL 1=SI; 0=NO"  },
'ord_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "ORDEN DENTRO DEL COMPROBANTE"  },
'xml_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "ARCHIVO XML 1=SI ;0=NO"  },
'req_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CAMPO REQUERIDO"  },
'cll_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "SE COLAPSA CON DATOS EN BLANCO"  },
'dbl_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "DATO NUMERICO"  },
'mee_cfd': {type: DataTypes.STRING(128),allowNull: false,comment: "MENSAJE DE ERROR"  },
'add_cfd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE ADDENDA"  },
