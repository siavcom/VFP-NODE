...
'cor_prd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE CORRIDA"  },
'mov_prm': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE MOVIMIENTO"  },
...
'med_prm': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "MEDIDA DE INSUMO"  },
