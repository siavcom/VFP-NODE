...
'mon_ped': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "MONEDA"  },
...
'sco_ped': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "STATUS DE COSTEO"  },
