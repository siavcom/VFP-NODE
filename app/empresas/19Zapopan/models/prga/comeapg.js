...
'apg_apg': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NO DE AUTORIZACION DE AMPLIACION DEL PRESUPUESTO DE GASTO"  },
...
'med_apg': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "MEDIDA"  },
...
'hdi_apg': {type: DataTypes.STRING(1024),allowNull: false,comment: "HUELLA DIGITAL"  },
'ctr_apg': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CON CARGO AL TRABAJADO 1=SI; 0=NO"  },
