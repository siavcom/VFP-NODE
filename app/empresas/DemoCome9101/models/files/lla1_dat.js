...
'des_dat': {type: DataTypes.CHAR(20),allowNull: false,defaultValue: ' ',comment: 'DESCRIPCION DEL CAMPO' },
...
'ref_dat': {type: DataTypes.CHAR(250),allowNull: false,defaultValue: ' ',comment: 'DESCRIPCION DE LA VARIABLE' },
