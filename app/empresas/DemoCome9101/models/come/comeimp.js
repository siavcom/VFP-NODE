...
'imp_imp': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE IMPUESTO"  },
...
'acu_imp': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "IMPUESTO ACUMULATIVO"  },
