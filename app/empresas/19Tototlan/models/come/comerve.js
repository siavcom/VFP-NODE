...
'cam_cam': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CAMIION"  },
'frt_rve': {type: DataTypes.DATE,allowNull: false,comment: "FECHA DE RUTA"  },
'sta_rve': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "STATUS 1=ACTIVO 0=DESACTIVO"  },
