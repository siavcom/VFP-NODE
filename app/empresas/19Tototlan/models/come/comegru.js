...
'sis_prg': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "SISTEMA AL QUE TIENE ACCESO"  },
'tpr_prg': {type: DataTypes.CHAR(1),allowNull: false,defaultValue: ' ',comment: "TIPO DE PROGRAMA"  },
'num_prg': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE PROGRAMA"  },
