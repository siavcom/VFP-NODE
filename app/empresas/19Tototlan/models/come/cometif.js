...
'nmo_tif': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NUMERO DE MOVIMIENTO DENTRO DEL FOLIIO"  },
...
'med_tif': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "UNIDAD"  },
