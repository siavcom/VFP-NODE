...
'cor_prd': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "CORRIDA"  },
'mov_prm': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "NO DE MOVIMIENTO"  },
...
'med_drm': {type: DataTypes.SMALLINT,allowNull: false,defaultValue: '0',comment: "MEDIDA"  },
