...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('man_comepry', {
...
'fco_pry': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "FORMA DE COTIZACION 1=POR DESCRIPCION 2=POR INSUMO"  },
...
'mco_pry': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "MONEDA DE COTIZACION"  },
