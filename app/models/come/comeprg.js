...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('man_comeprg', {
...
'sis_prg': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "NUMERO DE  SISTEMA DEL PROGRAMA"  },
'num_prg': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "NUMERO DEL PROGRAMA"  },
...
'frm_prg': {type: DataTypes.TEXT,allowNull: false,comment: "FORMATO"  },
