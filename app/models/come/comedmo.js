...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('man_comedmo', {
...
'num_mos': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "KEY_PRI QUE CORRESPONDE AL CLIENTE DE MOSTRADOS"  },
