...
'ave_tda': {type: DataTypes.BOOLEAN,allowNull: false,defaultValue: '0',comment: "ALMACEN DE VENTA (CONTABLE)"  },
'alc_tda': {type: DataTypes.BOOLEAN,allowNull: false,defaultValue: '0',comment: "ALMACEN DE CLIENTE"  },
'cod_nom': {type: DataTypes.CHAR(12),allowNull: false,defaultValue: ' ',comment: "CLIENTE AL CUAL PERTENECE EL ALMACEN"  },
'mub_tda': {type: DataTypes.BOOLEAN,allowNull: false,defaultValue: '0',comment: "MANEJA UBICACONES"  },
