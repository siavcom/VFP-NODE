...
'ntl_tel': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "NUMERO DE TELEGRAMA ENVIADO"  },
...
'usu_usu': {type: DataTypes.INTEGER,allowNull: true,defaultValue: '0',comment: "USUARIO QUE REALIZO LA MODIFICACION"  },
