...
'mov_mov': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "MOVIMIENTO"  },
'ens_mov': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "ENSABLE DEL MOVIMIENTO"  },
