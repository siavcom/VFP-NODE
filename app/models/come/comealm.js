...
'dac_alm': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DIAS A CUBRIR"  },
'ins_alm': {type: DataTypes.DECIMAL(7,2),allowNull: false,defaultValue: '0',comment: "INVENTARIO DE SEGURIDAD"  },
'cci_alm': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "CONTEOS CICLICOS"  },
