...
'dci_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES DE CAPTURA EN INVENTARIO"  },
'pgi_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "PERIODOS A GUARDAR DE INVEN."  },
'dcp_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES DE CAPTURA EN PRECIOS"  },
...
'an1_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "1 RANGO ANALISIS ANT. DE SALDOS"  },
'an2_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "2 RANGO ANALISIS ANT. DE SALDOS"  },
'an3_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "3 RANGO ANALISIS ANT. DE SALD.OS"  },
...
'fde_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "No. FAM. SOBRE LA CUAL ACTUAN LOS DES."  },
...
'li1_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "1 LIMITE PAGO DE DOCTOS VEND."  },
'li2_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "2 LIMITE PAGO DE DOCTOS VEND."  },
'li3_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "3 LIMITE PAGO DE DOCTOS VEND."  },
'li4_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "4 LIMITE PAGO DE DOCTOS VEND."  },
'li5_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "5 LIMITE PAGO DE DOCTOS VEND."  },
...
'dbl_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DIAS VENCIDOS PARA BLOQUEAR DOCUMENTOS"  },
...
'ser_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "SERIE"  },
...
'mpv_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "MONEDA DE PRECIO DE VENTA"  },
...
'dm1_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES MONEDA UNO"  },
'dm2_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES MONEDA DOS"  },
'dm3_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES MONEDA TRES"  },
'dm4_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES MONEDA CUATRO"  },
'dm5_pge': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "DECIMALES MONEDA CINCO"  },
