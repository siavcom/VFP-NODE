...
'num_fam': {type: DataTypes.INTEGER,allowNull: false,defaultValue: '0',comment: "NUMERO DE FAMILIA"  },
...
'esw_fam': {type: DataTypes.BOOLEAN,allowNull: false,defaultValue: '0',comment: "ESTATUS WEB 1=SI"  },
