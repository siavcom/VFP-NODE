module.exports = app => {
  ...
  const siavcom = require("../controllers/siavcom.controllers.js");
  ...
  router.get('/', function (req, res) {
    console.log('Pagina Web Siavcom')
  ...
  router.get("/sql", siavcom.sql);
  router.put("/sql", siavcom.sql);
  router.post("/sql", siavcom.sql);
  router.delete("/sql", siavcom.sql);
